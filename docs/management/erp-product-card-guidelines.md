...
3. **Новые предлагаемые атрибуты** (`max_*`, `aquaphor_filter_type` и др.) — заполнение **впрок** для AI-фильтрации по воде. Через 1-2 недели после backend Phase 1.5 — заработают для AI-подбора по карте и smart-search.
...
Плюс правильная категория МС и заполненные существующие атрибуты МС («...элемент для обслуживания», «...услуга для обслуживания», «Средний срок службы расходника», «Электронный гарантийный талон») — они используются другими функциями приложения PROSTOR (карточки расходников, гарантийные обязательства).
...
**Минимум для немедленной публикации:** все пункты группы **[✅ Уже работает]**. Это даёт работающий AI-поиск по описанию и фото плюс корректное отображение расходников и услуг в приложении PROSTOR. Группа **[🟡 Скоро]** заполняется впрок — slovo AI догонит после deploy Phase 1.5.
