...
>
> **Версия документа:** 1.6 (2026-05-19, синхронизировано с реальным кодом feeder'a `crm-aqua-kinetics-back/src/modules/moy-sklad/modules/catalog-sync/` — функции `fetchGroupContext`, `buildContentForEmbedding`, `parseComponentRefs`).
>
...
**Версия документа:** 1.6 (2026-05-19)
