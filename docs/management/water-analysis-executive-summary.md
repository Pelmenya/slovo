...
| Per-record | $0.014 | **1.40 ₽/бланк** |

**Что в эту цифру не входит** (бесплатное):
- Геокодирование (уже оплачено в Ahunter подписке) — 97.6% бланков получили координаты
