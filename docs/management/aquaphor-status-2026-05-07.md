...
**Зрелость:** это **визуализация поверх готовых endpoint'ов** — `/water-analysis/similar` уже работает, архив 15 504 анализов готов, каталог 155 товаров готов. Backend изменений не требуется (только при появлении правил специалиста для bridge с каталогом). Чистая UI-задача.
